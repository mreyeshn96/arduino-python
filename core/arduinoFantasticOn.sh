...
query="INSERT INTO action(num_pin, value, fecha, usuario) VALUES ('lucesfantasticas', '1', '$fecha', '$usuario')"
mysql -u root -p$pass $db -e "$query"


cd /home/reyes/Documentos/GitHub/arduino-python
#echo 1 > core/state_arduino_pin8.txt
chmod 777 core/pyFantasticaOn.py
python3 core/pyFantasticaOn.py &
sleep 1
#pkill -f pyOn2.py
